// ORM class for table 'W_SL_ZKT_DEALER_D_1'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Jul 11 11:33:01 CST 2019
...
public class W_SL_ZKT_DEALER_D_1 extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("DEALER_ERP_NAME", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        DEALER_ERP_NAME = (String)value;
      }
    });
    ...
    setters.put("CUST_ACCOUNT_ID", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        CUST_ACCOUNT_ID = (String)value;
      }
    });
    setters.put("TERRITORY_ID", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        TERRITORY_ID = (String)value;
      }
    });
  ...
  public W_SL_ZKT_DEALER_D_1 with_INTEGRATION_ID(String INTEGRATION_ID) {
    this.INTEGRATION_ID = INTEGRATION_ID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DEALER_CODE(String DEALER_CODE) {
    this.DEALER_CODE = DEALER_CODE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DEALER_NAME(String DEALER_NAME) {
    this.DEALER_NAME = DEALER_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DEALER_SHORT_NAME(String DEALER_SHORT_NAME) {
    this.DEALER_SHORT_NAME = DEALER_SHORT_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_PARTNER_DEALER_CODE(String PARTNER_DEALER_CODE) {
    this.PARTNER_DEALER_CODE = PARTNER_DEALER_CODE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_PARTNER_DEALER_NAME(String PARTNER_DEALER_NAME) {
    this.PARTNER_DEALER_NAME = PARTNER_DEALER_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_BG_CODE(String BG_CODE) {
    this.BG_CODE = BG_CODE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_BG_NAME(String BG_NAME) {
    this.BG_NAME = BG_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_BG_AREA_NAME(String BG_AREA_NAME) {
    this.BG_AREA_NAME = BG_AREA_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_BG_REGION_NAME(String BG_REGION_NAME) {
    this.BG_REGION_NAME = BG_REGION_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_BG_CITY_GROUP_NAME(String BG_CITY_GROUP_NAME) {
    this.BG_CITY_GROUP_NAME = BG_CITY_GROUP_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_BG_CITY_NAME(String BG_CITY_NAME) {
    this.BG_CITY_NAME = BG_CITY_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_WAREHOUSE_NAME(String WAREHOUSE_NAME) {
    this.WAREHOUSE_NAME = WAREHOUSE_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_PROVINCE_NAME(String PROVINCE_NAME) {
    this.PROVINCE_NAME = PROVINCE_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_CITY_NAME(String CITY_NAME) {
    this.CITY_NAME = CITY_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_COUNTY_NAME(String COUNTY_NAME) {
    this.COUNTY_NAME = COUNTY_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_RESPONSIBLE_NAME(String RESPONSIBLE_NAME) {
    this.RESPONSIBLE_NAME = RESPONSIBLE_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_RESPONSIBLE_PHONE(String RESPONSIBLE_PHONE) {
    this.RESPONSIBLE_PHONE = RESPONSIBLE_PHONE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_EMAIL_ADDR(String EMAIL_ADDR) {
    this.EMAIL_ADDR = EMAIL_ADDR;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_OFFICE_ADDR(String OFFICE_ADDR) {
    this.OFFICE_ADDR = OFFICE_ADDR;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_RECEIVE_ADDR(String RECEIVE_ADDR) {
    this.RECEIVE_ADDR = RECEIVE_ADDR;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_RECEIVE_NAME(String RECEIVE_NAME) {
    this.RECEIVE_NAME = RECEIVE_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_RECEIVE_PHONE(String RECEIVE_PHONE) {
    this.RECEIVE_PHONE = RECEIVE_PHONE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DEALER_TYPE(String DEALER_TYPE) {
    this.DEALER_TYPE = DEALER_TYPE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DEALER_LEVEL(String DEALER_LEVEL) {
    this.DEALER_LEVEL = DEALER_LEVEL;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_CHANNEL_TYPE(String CHANNEL_TYPE) {
    this.CHANNEL_TYPE = CHANNEL_TYPE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_CREATED_BY_ID(String CREATED_BY_ID) {
    this.CREATED_BY_ID = CREATED_BY_ID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_CHANGED_BY_ID(String CHANGED_BY_ID) {
    this.CHANGED_BY_ID = CHANGED_BY_ID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_CREATED_ON_DT(java.sql.Timestamp CREATED_ON_DT) {
    this.CREATED_ON_DT = CREATED_ON_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_CHANGED_ON_DT(java.sql.Timestamp CHANGED_ON_DT) {
    this.CHANGED_ON_DT = CHANGED_ON_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_AUX1_CHANGED_ON_DT(java.sql.Timestamp AUX1_CHANGED_ON_DT) {
    this.AUX1_CHANGED_ON_DT = AUX1_CHANGED_ON_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_AUX2_CHANGED_ON_DT(java.sql.Timestamp AUX2_CHANGED_ON_DT) {
    this.AUX2_CHANGED_ON_DT = AUX2_CHANGED_ON_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_AUX3_CHANGED_ON_DT(java.sql.Timestamp AUX3_CHANGED_ON_DT) {
    this.AUX3_CHANGED_ON_DT = AUX3_CHANGED_ON_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_AUX4_CHANGED_ON_DT(java.sql.Timestamp AUX4_CHANGED_ON_DT) {
    this.AUX4_CHANGED_ON_DT = AUX4_CHANGED_ON_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_W_INSERT_DT(java.sql.Timestamp W_INSERT_DT) {
    this.W_INSERT_DT = W_INSERT_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_W_UPDATE_DT(java.sql.Timestamp W_UPDATE_DT) {
    this.W_UPDATE_DT = W_UPDATE_DT;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_ETL_PROC_WID(java.math.BigDecimal ETL_PROC_WID) {
    this.ETL_PROC_WID = ETL_PROC_WID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DATE_FROM(java.sql.Timestamp DATE_FROM) {
    this.DATE_FROM = DATE_FROM;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DATE_TO(java.sql.Timestamp DATE_TO) {
    this.DATE_TO = DATE_TO;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_VERSION(java.math.BigDecimal VERSION) {
    this.VERSION = VERSION;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_ROW_ID(String ROW_ID) {
    this.ROW_ID = ROW_ID;
    return this;
  }
  private String DEALER_ERP_NAME;
  public String get_DEALER_ERP_NAME() {
    return DEALER_ERP_NAME;
  }
  public void set_DEALER_ERP_NAME(String DEALER_ERP_NAME) {
    this.DEALER_ERP_NAME = DEALER_ERP_NAME;
  }
  public W_SL_ZKT_DEALER_D_1 with_DEALER_ERP_NAME(String DEALER_ERP_NAME) {
    this.DEALER_ERP_NAME = DEALER_ERP_NAME;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_DATASOURCE_ID(String DATASOURCE_ID) {
    this.DATASOURCE_ID = DATASOURCE_ID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_AREA_CODE(String AREA_CODE) {
    this.AREA_CODE = AREA_CODE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_SALE_TYPE(String SALE_TYPE) {
    this.SALE_TYPE = SALE_TYPE;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_IS_WAREHOUSE_CUSTOMER(String IS_WAREHOUSE_CUSTOMER) {
    this.IS_WAREHOUSE_CUSTOMER = IS_WAREHOUSE_CUSTOMER;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_TEST_FLG(String TEST_FLG) {
    this.TEST_FLG = TEST_FLG;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_STATUS(String STATUS) {
    this.STATUS = STATUS;
    return this;
  }
  private String CUST_ACCOUNT_ID;
  public String get_CUST_ACCOUNT_ID() {
    return CUST_ACCOUNT_ID;
  }
  public void set_CUST_ACCOUNT_ID(String CUST_ACCOUNT_ID) {
    this.CUST_ACCOUNT_ID = CUST_ACCOUNT_ID;
  }
  public W_SL_ZKT_DEALER_D_1 with_CUST_ACCOUNT_ID(String CUST_ACCOUNT_ID) {
    this.CUST_ACCOUNT_ID = CUST_ACCOUNT_ID;
    return this;
  }
  ...
  public void set_TERRITORY_ID(String TERRITORY_ID) {
    this.TERRITORY_ID = TERRITORY_ID;
  }
  public W_SL_ZKT_DEALER_D_1 with_TERRITORY_ID(String TERRITORY_ID) {
    this.TERRITORY_ID = TERRITORY_ID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_ROW_WID(java.math.BigDecimal ROW_WID) {
    this.ROW_WID = ROW_WID;
    return this;
  }
  ...
  public W_SL_ZKT_DEALER_D_1 with_ID(java.math.BigDecimal ID) {
    this.ID = ID;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof W_SL_ZKT_DEALER_D_1)) {
      return false;
    }
    W_SL_ZKT_DEALER_D_1 that = (W_SL_ZKT_DEALER_D_1) o;
    boolean equal = true;
    ...
    equal = equal && (this.DEALER_ERP_NAME == null ? that.DEALER_ERP_NAME == null : this.DEALER_ERP_NAME.equals(that.DEALER_ERP_NAME));
    ...
    equal = equal && (this.CUST_ACCOUNT_ID == null ? that.CUST_ACCOUNT_ID == null : this.CUST_ACCOUNT_ID.equals(that.CUST_ACCOUNT_ID));
    equal = equal && (this.TERRITORY_ID == null ? that.TERRITORY_ID == null : this.TERRITORY_ID.equals(that.TERRITORY_ID));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.INTEGRATION_ID = JdbcWritableBridge.readString(1, __dbResults);
    this.DEALER_CODE = JdbcWritableBridge.readString(2, __dbResults);
    this.DEALER_NAME = JdbcWritableBridge.readString(3, __dbResults);
    this.DEALER_SHORT_NAME = JdbcWritableBridge.readString(4, __dbResults);
    this.PARTNER_DEALER_CODE = JdbcWritableBridge.readString(5, __dbResults);
    this.PARTNER_DEALER_NAME = JdbcWritableBridge.readString(6, __dbResults);
    this.BG_CODE = JdbcWritableBridge.readString(7, __dbResults);
    this.BG_NAME = JdbcWritableBridge.readString(8, __dbResults);
    this.BG_AREA_NAME = JdbcWritableBridge.readString(9, __dbResults);
    this.BG_REGION_NAME = JdbcWritableBridge.readString(10, __dbResults);
    this.BG_CITY_GROUP_NAME = JdbcWritableBridge.readString(11, __dbResults);
    this.BG_CITY_NAME = JdbcWritableBridge.readString(12, __dbResults);
    this.WAREHOUSE_NAME = JdbcWritableBridge.readString(13, __dbResults);
    this.PROVINCE_NAME = JdbcWritableBridge.readString(14, __dbResults);
    this.CITY_NAME = JdbcWritableBridge.readString(15, __dbResults);
    this.COUNTY_NAME = JdbcWritableBridge.readString(16, __dbResults);
    this.RESPONSIBLE_NAME = JdbcWritableBridge.readString(17, __dbResults);
    this.RESPONSIBLE_PHONE = JdbcWritableBridge.readString(18, __dbResults);
    this.EMAIL_ADDR = JdbcWritableBridge.readString(19, __dbResults);
    this.OFFICE_ADDR = JdbcWritableBridge.readString(20, __dbResults);
    this.RECEIVE_ADDR = JdbcWritableBridge.readString(21, __dbResults);
    this.RECEIVE_NAME = JdbcWritableBridge.readString(22, __dbResults);
    this.RECEIVE_PHONE = JdbcWritableBridge.readString(23, __dbResults);
    this.DEALER_TYPE = JdbcWritableBridge.readString(24, __dbResults);
    this.DEALER_LEVEL = JdbcWritableBridge.readString(25, __dbResults);
    this.CHANNEL_TYPE = JdbcWritableBridge.readString(26, __dbResults);
    this.CREATED_BY_ID = JdbcWritableBridge.readString(27, __dbResults);
    this.CHANGED_BY_ID = JdbcWritableBridge.readString(28, __dbResults);
    this.CREATED_ON_DT = JdbcWritableBridge.readTimestamp(29, __dbResults);
    this.CHANGED_ON_DT = JdbcWritableBridge.readTimestamp(30, __dbResults);
    this.AUX1_CHANGED_ON_DT = JdbcWritableBridge.readTimestamp(31, __dbResults);
    this.AUX2_CHANGED_ON_DT = JdbcWritableBridge.readTimestamp(32, __dbResults);
    this.AUX3_CHANGED_ON_DT = JdbcWritableBridge.readTimestamp(33, __dbResults);
    this.AUX4_CHANGED_ON_DT = JdbcWritableBridge.readTimestamp(34, __dbResults);
    this.W_INSERT_DT = JdbcWritableBridge.readTimestamp(35, __dbResults);
    this.W_UPDATE_DT = JdbcWritableBridge.readTimestamp(36, __dbResults);
    this.ETL_PROC_WID = JdbcWritableBridge.readBigDecimal(37, __dbResults);
    this.DATE_FROM = JdbcWritableBridge.readTimestamp(38, __dbResults);
    this.DATE_TO = JdbcWritableBridge.readTimestamp(39, __dbResults);
    this.VERSION = JdbcWritableBridge.readBigDecimal(40, __dbResults);
    this.ROW_ID = JdbcWritableBridge.readString(41, __dbResults);
    this.DEALER_ERP_NAME = JdbcWritableBridge.readString(42, __dbResults);
    this.DATASOURCE_ID = JdbcWritableBridge.readString(43, __dbResults);
    this.AREA_CODE = JdbcWritableBridge.readString(44, __dbResults);
    this.SALE_TYPE = JdbcWritableBridge.readString(45, __dbResults);
    this.IS_WAREHOUSE_CUSTOMER = JdbcWritableBridge.readString(46, __dbResults);
    this.TEST_FLG = JdbcWritableBridge.readString(47, __dbResults);
    this.STATUS = JdbcWritableBridge.readString(48, __dbResults);
    this.CUST_ACCOUNT_ID = JdbcWritableBridge.readString(49, __dbResults);
    this.TERRITORY_ID = JdbcWritableBridge.readString(50, __dbResults);
    this.ROW_WID = JdbcWritableBridge.readBigDecimal(51, __dbResults);
    this.ID = JdbcWritableBridge.readBigDecimal(52, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(INTEGRATION_ID, 1 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DEALER_CODE, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DEALER_NAME, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DEALER_SHORT_NAME, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(PARTNER_DEALER_CODE, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(PARTNER_DEALER_NAME, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(BG_CODE, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(BG_NAME, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(BG_AREA_NAME, 9 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(BG_REGION_NAME, 10 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(BG_CITY_GROUP_NAME, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(BG_CITY_NAME, 12 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(WAREHOUSE_NAME, 13 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(PROVINCE_NAME, 14 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(CITY_NAME, 15 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(COUNTY_NAME, 16 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(RESPONSIBLE_NAME, 17 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(RESPONSIBLE_PHONE, 18 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(EMAIL_ADDR, 19 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(OFFICE_ADDR, 20 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(RECEIVE_ADDR, 21 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(RECEIVE_NAME, 22 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(RECEIVE_PHONE, 23 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DEALER_TYPE, 24 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DEALER_LEVEL, 25 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(CHANNEL_TYPE, 26 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(CREATED_BY_ID, 27 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(CHANGED_BY_ID, 28 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeTimestamp(CREATED_ON_DT, 29 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(CHANGED_ON_DT, 30 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(AUX1_CHANGED_ON_DT, 31 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(AUX2_CHANGED_ON_DT, 32 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(AUX3_CHANGED_ON_DT, 33 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(AUX4_CHANGED_ON_DT, 34 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(W_INSERT_DT, 35 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(W_UPDATE_DT, 36 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(ETL_PROC_WID, 37 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeTimestamp(DATE_FROM, 38 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(DATE_TO, 39 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(VERSION, 40 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(ROW_ID, 41 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DEALER_ERP_NAME, 42 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DATASOURCE_ID, 43 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(AREA_CODE, 44 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(SALE_TYPE, 45 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(IS_WAREHOUSE_CUSTOMER, 46 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(TEST_FLG, 47 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STATUS, 48 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(CUST_ACCOUNT_ID, 49 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(TERRITORY_ID, 50 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(ROW_WID, 51 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(ID, 52 + __off, 2, __dbStmt);
    return 52;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.DEALER_ERP_NAME = null;
    } else {
    this.DEALER_ERP_NAME = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    this.CUST_ACCOUNT_ID = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.TERRITORY_ID = null;
    } else {
    this.TERRITORY_ID = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.ROW_WID = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.DEALER_ERP_NAME) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, DEALER_ERP_NAME);
    }
    ...
    if (null == this.CUST_ACCOUNT_ID) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, CUST_ACCOUNT_ID);
    }
    if (null == this.TERRITORY_ID) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, TERRITORY_ID);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(DEALER_ERP_NAME==null?"null":DEALER_ERP_NAME, delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(CUST_ACCOUNT_ID==null?"null":CUST_ACCOUNT_ID, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(TERRITORY_ID==null?"null":TERRITORY_ID, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.DEALER_ERP_NAME = null; } else {
      this.DEALER_ERP_NAME = __cur_str;
    }
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.CUST_ACCOUNT_ID = null; } else {
      this.CUST_ACCOUNT_ID = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.TERRITORY_ID = null; } else {
      this.TERRITORY_ID = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    W_SL_ZKT_DEALER_D_1 o = (W_SL_ZKT_DEALER_D_1) super.clone();
  ...
  public void clone0(W_SL_ZKT_DEALER_D_1 o) throws CloneNotSupportedException {
    o.CREATED_ON_DT = (o.CREATED_ON_DT != null) ? (java.sql.Timestamp) o.CREATED_ON_DT.clone() : null;
    o.CHANGED_ON_DT = (o.CHANGED_ON_DT != null) ? (java.sql.Timestamp) o.CHANGED_ON_DT.clone() : null;
    o.AUX1_CHANGED_ON_DT = (o.AUX1_CHANGED_ON_DT != null) ? (java.sql.Timestamp) o.AUX1_CHANGED_ON_DT.clone() : null;
    o.AUX2_CHANGED_ON_DT = (o.AUX2_CHANGED_ON_DT != null) ? (java.sql.Timestamp) o.AUX2_CHANGED_ON_DT.clone() : null;
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("DEALER_ERP_NAME", this.DEALER_ERP_NAME);
    ...
    __sqoop$field_map.put("CUST_ACCOUNT_ID", this.CUST_ACCOUNT_ID);
    __sqoop$field_map.put("TERRITORY_ID", this.TERRITORY_ID);
