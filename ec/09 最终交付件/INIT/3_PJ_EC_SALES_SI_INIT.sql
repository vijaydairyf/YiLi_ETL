...
where t.date_>='201801' and t.bg_wid=3 and t.prod_wid<>-1 and t1.erp_id  like '2%'
...
3 bg_wid,
nvl(c.platform_name,'其他') as platform_name,
nvl(c.sale_area_name,'其他') as sale_area_name,
-1 dealer_wid,
'其他'  erp_id,
'其他'  pro_id,
...
from datalake_md.fact_ec_budget_plan where src_identity='SI' and year_month >='201801' and year_month <=concat(substr(date_sub(current_date,1),1,4),'12')) b
...
select * from bigdata_dm.pj_ec_sales_si_mtd_tmp;
