...
t.sales_dt_wid,
t.bg_wid,
nvl(t3.platform_name,'其他') as platform_name,
nvl(t3.sale_area_name,'其他') as sale_area_name,
t.dealer_wid,
nvl(t1.erp_id,'其他') as erp_id,
'-1' as pro_id,
nvl(t1.pro_categ_name,'其他') as pro_categ_name,
nvl(t1.pro_brand_name,'其他') as pro_brand_name,
case when t1.pro_grade='无' or t1.pro_grade='未定义'  or t1.pro_grade ='缺省'  or  t1.pro_grade ='其他' then '空' else t1.pro_grade end pro_grade,
t.site_wid,
...
3 bg_wid,
nvl(b.platform_name,'其他') as platform_name, --平台
nvl(b.sale_area_name,'其他') as sale_area_name, --店铺
-1 dealer_wid,
'其他'  erp_id,
'其他'  pro_id,
nvl(b.pro_categ_name,'其他') as pro_categ_name,
nvl(b.pro_brand_name,'其他') pro_brand_name, --品牌
'空' pro_grade,
-1 site_wid,
from_unixtime(unix_timestamp(),'yyyy-MM-dd HH:mm:ss')  as w_insert_dt,
0 price_before,
...
left join (select 
area as platform_name, --平台
store as sale_area_name, --店铺
brand as pro_brand_name, --品牌
prod_desc as pro_categ_name,
year_month as mon_id,
cast(if(tax_amt='',0,nvl(tax_amt,0)) as decimal(38,10) )*10000 as task_amt_before
...
--left join (select distinct platform_name,sale_area_name as sale_area_name1,final_name as sale_area_name from bigdata_dw.w_ec_area_d_tmp where platform_type = 'SI') c --更改模板后导入的店铺名称为最终名称,无需再使用映射表
