...
left join bigdata_dw.dm_tpm_area_d region on t.sales_region_id = region.tpm_region_id and region.div_type = 'region'
...
select bg.row_wid as bg_wid
        ...
        ,case when area.div_type = 'area' then '缺省' else area.area_name end as region_name--执行区域
